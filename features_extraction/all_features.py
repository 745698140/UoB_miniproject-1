...
class lob:
    ...
    def mid_price_deeper_levels(self, depth = 2):
        return (self.ask[depth-1][0] + self.bid[-(depth-1)][0]) / 2
    ...
    def bid_ask_spread(self):
        return self.max_bid - self.min_ask
